...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  var _currPageValue =
      0.0; // when we slide the carousel the pagevalue changes from 0 to 4
  ...
  //clearing memory because we used the event listener on init
  @override
  void dispose() {
            ...
            itemBuilder: (context, index) => Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      //Text area section on the right
                      Expanded(
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                                ...
                                children: [
                                  BigText(text: "Texas Burger"),
                                  SizedBox(height: Dimensions.height10),
                                  SmallText(text: "With Texas BBQ sauce."),
                                  SizedBox(height: Dimensions.height10),
                                  Row(
                                    mainAxisAlignment:
  ...
  Widget _buildPageItem(int index) {
    //Creating a matrix for zooming in on the selected page of the carousel
